...
songData[#songData+1] = {id=5, name="觀音靈感真言", file="s3.mp3", time=93, count=1, type=2, touchMax=132, touchMin=88}
songData[#songData+1] = {id=6, name="準提神咒", file="s4.mp3", time=63, count=1, type=2, touchMax=148, touchMin=99}
...
huixiangwen = "huixiangwen.mp3",--回向文
}
