--¹­±ø½«Áì
local GongbingLeader = class("GongbingLeader", require(luaFile.RoleLeader))

function GongbingLeader:ctor(param)
    self:init(param)
end

function GongbingLeader:init(param)
end

function GongbingLeader:becomeStrong(param)
...
function GongbingLeader:starGameWithJob()
    performWithDelay(self, function() self:becomeStrong() end, 1)
end

return GongbingLeader